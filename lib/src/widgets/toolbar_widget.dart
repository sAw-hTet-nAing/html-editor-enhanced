...
class ToolbarWidget extends StatefulWidget {
  ...
  const ToolbarWidget({Key? key, required this.controller, required this.htmlToolbarOptions, required this.callbacks})
    : super(key: key);
                ...
                child: CustomDropdownButton<String>(
                  ...
                  items: [
                    CustomDropdownMenuItem(
                      value: 'Courier New',
                      child: PointerInterceptor(
                        child: Text('Courier New', style: TextStyle(fontFamily: 'Courier')),
                      ),
                    ),
                    CustomDropdownMenuItem(
                      value: 'sans-serif',
                      child: PointerInterceptor(
                        child: Text('Sans Serif', style: TextStyle(fontFamily: 'sans-serif')),
                      ),
                    ),
                    CustomDropdownMenuItem(
                      value: 'Times New Roman',
                      child: PointerInterceptor(
                        child: Text('Times New Roman', style: TextStyle(fontFamily: 'Times')),
                      ),
                    ),
                  ],
              ...
              if (_colorSelected[index]) {
                if (t.getIcons()[index].icon == Icons.format_color_text) {
                  ...
                  if (proceed) {
                    widget.controller.execCommand(
                      'foreColor',
                      argument: (Colors.black.toARGB32() & 0xFFFFFF).toRadixString(16).padLeft(6, '0').toUpperCase(),
                    );
                    updateStatus(null);
                  }
                }
                if (t.getIcons()[index].icon == Icons.format_color_fill) {
                  ...
                  if (proceed) {
                    widget.controller.execCommand(
                      'hiliteColor',
                      argument: (Colors.yellow.toARGB32() & 0xFFFFFF).toRadixString(16).padLeft(6, '0').toUpperCase(),
                    );
                    updateStatus(null);
                  }
                }
              ...
              child: CustomDropdownButtonHideUnderline(
                child: CustomDropdownButton<double>(
                  ...
                  items: [
                    ...
                    CustomDropdownMenuItem(value: 1.2, child: PointerInterceptor(child: Text('1.2'))),
                    CustomDropdownMenuItem(value: 1.4, child: PointerInterceptor(child: Text('1.4'))),
                    CustomDropdownMenuItem(value: 1.5, child: PointerInterceptor(child: Text('1.5'))),
                    CustomDropdownMenuItem(value: 1.6, child: PointerInterceptor(child: Text('1.6'))),
                    CustomDropdownMenuItem(value: 1.8, child: PointerInterceptor(child: Text('1.8'))),
                    CustomDropdownMenuItem(value: 2, child: PointerInterceptor(child: Text('2.0'))),
        ...
        if (t.textDirection) {
          toolbarChildren.add(
            ToggleButtons(
              ...
              children: [Icon(Icons.format_textdirection_l_to_r), Icon(Icons.format_textdirection_r_to_l)],
            ),
          );
        }
        if (t.caseConverter) {
          ...
          ToggleButtons(
            ...
            onPressed: (int index) async {
              if (t.getIcons()[index].icon == Icons.link) {
                var proceed =
                    await widget.htmlToolbarOptions.onButtonPressed?.call(ButtonType.link, null, null) ?? true;
                if (proceed) {
                                ...
                                TextButton(
                                  onPressed: () async {
                                    if (filename.text.isEmpty && url.text.isEmpty) {
                                      ...
                                      var proceed =
                                          await widget.htmlToolbarOptions.mediaUploadInterceptor?.call(
                                            result!.files.single,
                                      ...
                                      var proceed =
                                          await widget.htmlToolbarOptions.mediaLinkInsertInterceptor?.call(
                                            url.text,
                                            InsertFileType.image,
                                          ) ??
                                          true;
              ...
              if (t.getIcons()[index].icon == Icons.audiotrack_outlined) {
                var proceed =
                    await widget.htmlToolbarOptions.onButtonPressed?.call(ButtonType.audio, null, null) ?? true;
                if (proceed) {
                  final filename = TextEditingController();
                  final url = TextEditingController();
                  final urlFocus = FocusNode();
              ...
              if (t.getIcons()[index].icon == Icons.videocam_outlined) {
                var proceed =
                    await widget.htmlToolbarOptions.onButtonPressed?.call(ButtonType.video, null, null) ?? true;
                if (proceed) {
                  final filename = TextEditingController();
                  final url = TextEditingController();
                  final urlFocus = FocusNode();
              ...
              if (t.getIcons()[index].icon == Icons.table_chart_outlined) {
                var proceed =
                    await widget.htmlToolbarOptions.onButtonPressed?.call(ButtonType.table, null, null) ?? true;
                if (proceed) {
                  var currentRows = 1;
                  var currentCols = 1;
                  await showDialog(
                                  ...
                                  child: SingleChildScrollView(
                                    child: DataTable(
                                      ...
                                      columns: const <DataColumn>[
                                        DataColumn(
                                          label: Text('Key Combination', style: TextStyle(fontStyle: FontStyle.italic)),
                                        ),
                                        DataColumn(
                                      ...
                                      rows: const <DataRow>[
                                        DataRow(cells: <DataCell>[DataCell(Text('ESC')), DataCell(Text('Escape'))]),
                                        DataRow(
                                          cells: <DataCell>[
                                            DataCell(Text('ENTER')),
                                        ...
                                        DataRow(cells: <DataCell>[DataCell(Text('TAB')), DataCell(Text('Tab'))]),
                                        DataRow(
                                          cells: <DataCell>[DataCell(Text('SHIFT+TAB')), DataCell(Text('Untab'))],
                                        ),
                                        DataRow(
                                          cells: <DataCell>[
